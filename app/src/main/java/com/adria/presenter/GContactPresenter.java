...
import com.adria.model.GContactModel;
 ...
 * Simple presenter that implements {@link GContactContract.Presenter},
 * delegate view requests to model, and update the view with data
 */
public class GContactPresenter implements GContactContract.Presenter {
    GContactModel mModel;
    GContactContract.View mView;
    ...
    public GContactPresenter(GContactContract.View view) {
        this.mView = view;
    }
